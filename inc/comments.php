...
function base_pagination() {
	...
	$paginate_links = paginate_links( array(
		...
		'mid_size' => 5,
		'prev_next' => true,
	    'prev_text' => __( '&laquo;', 'base' ),
	    'next_text' => __( '&raquo;', 'base' ),
		'type' => 'list',
	) );
...
if ( ! class_exists( 'Base_Comments' ) ) :
class Base_Comments extends Walker_Comment{
	...
	function __construct() { ?>
        ...
        <h3><?php comments_number( __( 'No Responses to', 'base' ), __( 'One Response to', 'base' ), __( '% Responses to', 'base' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<header class="comment-author">
			...
			<time datetime="<?php echo comment_date( 'c' ) ?>"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>"><?php printf( __( '%1$s', 'base' ), get_comment_date(),  get_comment_time() ) ?></a></time>
