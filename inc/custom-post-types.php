...
register_taxonomy( 'service-categories',
	...
	array('hierarchical' => true,
		'labels' => array(
			'name' => __( 'Service Categories', 'bsm' ),
			'singular_name' => __( 'Service Category', 'bsm' ),
			'search_items' =>  __( 'Search Service Categories', 'bsm' ),
			'all_items' => __( 'All Service Categories', 'bsm' ),
			'parent_item' => __( 'Parent Service Category', 'bsm' ),
			'parent_item_colon' => __( 'Parent Service Category:', 'bsm' ),
			'edit_item' => __( 'Edit Service Category', 'bsm' ),
			'update_item' => __( 'Update Service Category', 'bsm' ),
			'add_new_item' => __( 'Add New Service Category', 'bsm' ),
			'new_item_name' => __( 'New Service Category Name', 'bsm' )
		),
